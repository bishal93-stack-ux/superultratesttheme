...
$aut_name = get_the_author_meta('display_name',$author_id);
$aut_desc = get_the_author_meta('description',$author_id);
// $postID = get_queried_object_id();
//$query = new WP_Query( array( 'p' => $postID ) );
?>
                        ...
                        <div class="sticky-inner">
                            <div class="sidebar__inner">
									<span class="byline" itemprop="author">
										...
										<span class="author">
											<a href="#" class="url fn" itemprop="name"><?php echo $aut_name; ?></a>
										</span>
									</span>
...
// No value.
                    ...
                    <div class="entry-content">
                        ...
                        <p><img src="images/single-ad.jpg" alt=""></p>
                        ...
                        <p style="text-align: center;"><img src="images/single-ad2.jpg" alt=""></p>
                        ...
                        <h6>Heading H6</h6>
                        <figure class="wp-caption aligncenter">
                            <img class="size-full" src="images/img2.jpg" alt="" width="602" height="440">
                        ...
                        <p><figure style="max-width: 270px" class="wp-caption alignright">
                                <img class="size-full" src="images/img3.jpg" alt="" width="270" height="232">
                        ...
                        <p><img src="images/single-ad3.jpg" alt=""></p>
                ...
                <div class="author-profile">
                    ...
                    <div class="author-content-wrap">
                        ...
                        <div class="author-desc">
                            Raushan is the CEO/Co-founder of Raratheme.com. He has been using WordPress since 2012 and has helped hundreds of companies build online presence using WordPress. Raushan enjoys reading and writing about WordPress, Digital Marketing and Growth. When he is not working on WordPress, he is probably playing chess, reading a book, learning salsa, or hiking.
                        </div>
                        <ul class="social-list">
